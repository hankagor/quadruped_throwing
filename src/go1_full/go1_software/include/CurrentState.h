...
class CurrentState {
    public:
        ...
        void t265Callback(const nav_msgs::Odometry& msg);
    ...
    private:
        ros::NodeHandle nm;
        ros::Subscriber servo_sub[12], footForce_sub[4], imu_sub, state_sub, t265_sub;
        string robot_name;

        tf::TransformListener listener;
        geometry_msgs::PoseStamped pose_stamped_cam, pose_stamped_base;
        geometry_msgs::Vector3Stamped lin_vel_cam, lin_vel_base, ang_vel_cam, ang_vel_base;
